...
def the_trip_with_the_crates():
    ...
    line_follower(move_degrees=450, speed=30, gain=0.25)
    #two_wheel_move(left_degrees=723, right_degrees=330, speed=30)
    two_wheel_move(left_degrees=713, right_degrees=320, speed=30)
    grind(left_speed=20, right_speed=22, run_seconds=3)
    motor_front_left.run_for_degrees(-120, speed=MAX_SPEED)
    ...
    gyro_turn(input_angle=252, relative=False, timeout=2, left_or_right=TurnType.BOTH, counter_or_clock=TurnDirection.CLOCKWISE)
    hub.speaker.beep(100, 0.125)
